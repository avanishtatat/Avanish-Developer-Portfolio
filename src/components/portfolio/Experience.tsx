...
import { experienceContent, experienceItems } from "@/data/experience";
      ...
      <div className="container">
        ...
        >
          ...
          <h2 className="mt-3 font-display text-4xl sm:text-5xl font-bold tracking-tight">
            {experienceContent.heading.split("growing as a developer")[0]}
            <span className="neon-text">growing</span> as a developer.
          </h2>
        </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {experienceItems.map((item, i) => (
            ...
            >
              ...
              >
                <div
                  className={`absolute left-6 md:left-1/2 top-2 w-4 h-4 rounded-full bg-gradient-to-br ${item.color} -translate-x-1/2 ring-4 ring-background z-10 shadow-neon-purple`}
                />
